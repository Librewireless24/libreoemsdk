...
public class TunnelingControl {
    private static final String TAG = TunnelingControl.class.getSimpleName();
    ...
    static void addTunnelingClient(Socket socket){
        LibreLogger.d("addTunnelingClient","socket "+socket.getInetAddress().getHostAddress());
    ...
    public static Socket getTunnelingClient(String socketIp){
        LibreLogger.d("getTunnelingClient","socketIp "+socketIp +" isPresent = "+tunnelingClientsMap.containsKey(socketIp));
    ...
    public static void removeTunnelingClient(String socketIp){
        ...
        LibreLogger.d("removeTunnelingClient","isSocketPresent "+isSocketPresent);
        if (isSocketPresent){
            ...
            LibreLogger.d("removeTunnelingClient","socket "+socketIp+" removed");
        }
    }
...
//                    };
                    ...
                    if (!tunnelingClientsMap.containsKey(clientSocketIp)){
                        LibreLogger.d(TAG,"sendDataModeCommand socket not found "+clientSocketIp);
                        return;
                    }

                    Socket client = tunnelingClientsMap.get(clientSocketIp);
                    if (client == null || client.isClosed() || !client.isConnected()){
                        LibreLogger.d(TAG,"sendDataModeCommand socket null/closed/not connected");
...
//                    };
                    ...
                    if (!tunnelingClientsMap.containsKey(clientSocketIp)){
                        LibreLogger.d(TAG,"sendCommand socket not found "+clientSocketIp);
                        return;
                    }
