...
//            }
            ...
            if (dataItem.itemType.equals("Folder")) {
                ...
                itemBinding.itemIcon.setImageResource(R.mipmap.dms_album_art)
            ...
            {
                itemBinding.itemIcon.setImageResource(R.drawable.songs_border)
...
//                    itemBinding.itemFolder?.visibility = View.GONE
////                    itemView.item_icon?.setImageResource(R.drawable.songs_border)
//                }
//            }
