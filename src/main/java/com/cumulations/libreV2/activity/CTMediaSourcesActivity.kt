        ...
        binding.seekBarVolume.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            ...
            override fun onStopTrackingTouch(seekBar: SeekBar) {
                ...
                if (seekBar.progress == 0) {
                    binding.ivVolumeMute.setImageResource(R.drawable.riva_mute)
                } else
                    binding.ivVolumeMute.setImageResource(R.drawable.riva_volume_low)
...
//                TunnelingControl(currentIpAddress).sendCommand(PaysloadType.DEVICE_VOLUME,(seekBar.progress/5).toByte())
    ...
    private fun initViews() {
        ...
        if ( binding.seekBarVolume.progress == 0||sceneObject.mute_status == LUCIMESSAGES.MUTE) {
            binding.ivVolumeMute.setImageResource(R.drawable.riva_mute)
        } else binding.ivVolumeMute.setImageResource(R.drawable.riva_volume_low)
...
//               SUMA                 binding.ivVolumeMute.setImageResource(R.drawable.riva_mute)
//                            }
//                            else {
//                                binding.ivVolumeMute.setImageResource(R.drawable.riva_volume_low)
//                            }
        ...
        inner class SourceItemViewHolder(private val itemBinding: CtListItemMediaSourcesBinding) : RecyclerView.ViewHolder(itemBinding.root) {
            ...
            fun bindSourceItem(source: String?, position: Int) {
                ...
                when(source) {
                    ...
                    context.getString(R.string.dmr) -> itemBinding.ivSourceIcon.setImageResource(R.drawable.riva_device_icon)
                    context.getString(R.string.dmp) -> itemBinding.ivSourceIcon.setImageResource(R.drawable.riva_device_icon)
                    context.getString(R.string.spotify) -> itemBinding.ivSourceIcon.setImageResource(R.mipmap.spotify)
                    context.getString(R.string.usb) -> itemBinding.ivSourceIcon.setImageResource(R.drawable.riva_usb)
                    context.getString(R.string.sdcard) -> itemBinding.ivSourceIcon.setImageResource(R.mipmap.sdcard)
                    context.getString(R.string.melon) -> itemBinding.ivSourceIcon.setImageResource(R.drawable.riva_device_icon)
                    ...
                    context.getString(R.string.miracast) -> itemBinding.ivSourceIcon.setImageResource(R.drawable.riva_device_icon)
                    context.getString(R.string.playlist) -> itemBinding.ivSourceIcon.setImageResource(R.drawable.riva_device_icon)
                    context.getString(R.string.ddms_salve) -> itemBinding.ivSourceIcon.setImageResource(R.drawable.riva_device_icon)
                    context.getString(R.string.aux_in) -> itemBinding.ivSourceIcon.setImageResource(R.drawable.aux_enabled)
                    context.getString(R.string.apple_device) -> itemBinding.ivSourceIcon.setImageResource(R.drawable.riva_device_icon)
                    context.getString(R.string.direct_url) -> itemBinding.ivSourceIcon.setImageResource(R.drawable.riva_device_icon)
                    context.getString(R.string.q_play) -> itemBinding.ivSourceIcon.setImageResource(R.drawable.riva_device_icon)
                    ...
                    context.getString(R.string.external_source) -> itemBinding.ivSourceIcon.setImageResource(R.drawable.riva_device_icon)
                    context.getString(R.string.rtsp) -> itemBinding.ivSourceIcon.setImageResource(R.drawable.riva_device_icon)
