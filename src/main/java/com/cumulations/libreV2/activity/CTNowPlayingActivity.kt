...
/*              binding.ivPlayPause.setImageResource(R.drawable.play_white)
            ...
            ALEXA_SOURCE -> {
                ...
                binding.seekBarSong.isClickable = false
                binding.ivPlayPause.setImageResource(R.drawable.riva_play)
                binding.ivNext.setImageResource(R.drawable.riva_next_enabled)
                binding.ivPrevious.setImageResource(R.drawable.riva_prev_enabled)
...
//            }
                    ...
                    try {
                        ...
                        if (currentSceneObject!!.playstatus == CURRENTLY_PLAYING) {
                            if (currentSceneObject!!.currentSource != MIDCONST.GCAST_SOURCE) {
                                binding.ivPlayPause.setImageResource(R.drawable.riva_pause)
                                binding.ivNext.setImageResource(R.drawable.riva_next_enabled)
                                binding.ivPrevious.setImageResource(R.drawable.riva_prev_enabled)
                            }
                            if (currentSceneObject!!.currentSource != BT_SOURCE) {
                    ...
                    try {
                        ...
                        if (mScanHandler!!.isIpAvailableInCentralSceneRepo(currentIpAddress)) {
                            ...
                            if (binding.seekBarVolume.progress == 0) {
                                binding.ivVolumeDown.setImageResource(R.drawable.riva_mute)
                            } else binding.ivVolumeDown.setImageResource(R.drawable.riva_volume_low)
                        }
    ...
    private fun setViews() {
        ...
        if (binding.seekBarVolume.progress == 0) {
            ...
            if (currentSceneObject!!.mute_status == LUCIMESSAGES.MUTE) {
                ...
                binding.ivVolumeDown.setImageResource(R.drawable.riva_volume_low)
            }
        }
        ...
        if (currentSceneObject?.currentSource == GCAST_SOURCE
           ...
           /* || currentSceneObject!!.currentSource == USB_SOURCE*/
             ...
             */
            if (currentSceneObject!!.shuffleState == 0) {
                binding.ivShuffle.setImageResource(R.drawable.riva_shuffle_disabled)
            } else {
                binding.ivShuffle.setImageResource(R.drawable.riva_shuffle_enabled)
            }
        ...
        when (currentSceneObject!!.playstatus) {
            ...
            CURRENTLY_PLAYING -> {
                showLoader(false)
                if (playPauseNextPrevAllowed()) {
                    setPlayPauseLoader(binding.ivPlayPause, isEnabled = true, isLoader = false, image = R.drawable.riva_pause)
                    binding.ivNext.setImageResource(R.drawable.riva_next_enabled)
                    binding.ivPrevious.setImageResource(R.drawable.riva_prev_enabled)
                } else {
            ...
            CURRENTLY_PAUSED -> {
                showLoader(false)
                if (playPauseNextPrevAllowed()) {
                    setPlayPauseLoader(binding.ivPlayPause, isEnabled = true, isLoader = false, image = R.drawable.riva_play)
                    binding.ivNext.setImageResource(R.drawable.riva_next_enabled)
                    binding.ivPrevious.setImageResource(R.drawable.riva_prev_enabled)
                } else {
                    setPlayPauseLoader(binding.ivPlayPause, isEnabled = false, isLoader = false, image = R.drawable.play_white)
    ...
    */
    private fun setTheSourceIconFromCurrentSceneObject(i: Int) {
        ...
        var imgResId = R.drawable.riva_songs_border
        ...
        when (currentSceneObject?.currentSource) {
            ...
            USB_SOURCE -> imgResId = R.drawable.riva_usb
