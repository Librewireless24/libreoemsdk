                    ...
                    when (sceneObject.playstatus) {
                        ...
                        CURRENTLY_PLAYING -> {
                            if (playPauseNextPrevAllowed(sceneObject)) {
                                ...
                                setPlayPauseLoader(playPauseView!!, isEnabled = true, isLoader = false, image = R.drawable.riva_pause)
                            } else {
                        ...
                        CURRENTLY_STOPPED, CURRENTLY_PAUSED -> {
                            if (playPauseNextPrevAllowed(sceneObject)) {
                                ...
                                setPlayPauseLoader(playPauseView!!, isEnabled = true, isLoader = false, image = R.drawable.riva_play)
                            } else {
  ...
  //                        currentArtistName = sceneObject.artist_name!!
    ...
    fun setCurrentAlbumArtistName(currentSceneObject: SceneObject, currentAlbumName: AppCompatTextView) {
     ...
     fun setCurrentSourceIcon(currentSceneObject: SceneObject,
         ...
         LibreLogger.d("-->SHAIK", "setCurrentSourceIcon  ${currentSceneObject.currentSource} " + "visibilty ${currentSourceView.visibility == View.GONE} ")
            when (currentSceneObject.currentSource) {
                ...
                USB_SOURCE -> currentSourceView.setImageResource(R.drawable.riva_usb)
        ...
        when (currentSceneObject.playstatus) {
            ...
            CURRENTLY_PLAYING -> {
                ...
                if (playPauseNextPrevAllowed(currentSceneObject)) {
                    ...
                    setPlayPauseLoader(currentPlayPauseIcon, isEnabled = true, isLoader = false, image = R.drawable.riva_pause)
                } else {
            ...
            CURRENTLY_STOPPED, CURRENTLY_PAUSED -> {
                if (playPauseNextPrevAllowed(currentSceneObject)) {
                    ...
                    setPlayPauseLoader(currentPlayPauseIcon, isEnabled = true, isLoader = false, image = R.drawable.riva_play)
                } else {
...
//                        }
 ...
 //               updateMusicPlayViews(updatedSceneObject,7,musicPlayerIp!!)
        ...
        fun setControlIconsForAlexa(currentSceneObject: SceneObject?,
            ...
            if (next.isEnabled) {
                next.setImageResource(R.drawable.riva_play)
            } else {
            ...
            if (previous.isEnabled) {
                previous.setImageResource(R.drawable.riva_prev_enabled)
            } else {
