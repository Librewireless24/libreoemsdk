...
public class ContentTree {
    ...
    public final static String AUDIO_PLAY_LIST_ID = "2-5";
    public final static String AUDIO_PLAY_LIST_PREFIX = "2-5-";
    ...
    public final static String AUDIO_FOLDER_ID = "2-5";
    public final static String AUDIO_FOLDER_PREFIX = "2-5-";
