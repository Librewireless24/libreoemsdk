...
public class LUCIPacket {
    ...
    private static final String TAG = LUCIPacket.class.getSimpleName();
    ...
    */
    ...
    public int getPacket(byte[] packet) {
        ...
        for (int i = 0; i < payload_size; i++) {
            ...
            str += payload[i] +",";
            // LibreLogger.d(TAG,"p="+packet[HEADER_SIZE+i]);
        }
        LibreLogger.d(TAG, "Finalized String:: Luci Packet :" +str);
