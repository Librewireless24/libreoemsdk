...
//            LibreLogger.d("ip check","Bhargav in getActiveInterface "+iface.getName());
            ...
            if (iface.getName().startsWith("w")) {
                ...
                while (inetAddresses.hasMoreElements()) {
                    ...
                    if (!(addr.isLoopbackAddress() || addr.isLinkLocalAddress())) {
                        LibreLogger.d("getActiveNetworkInterface", "DisplayName " + iface.getDisplayName() + ",Name " + iface.getName()+",addr " + addr
