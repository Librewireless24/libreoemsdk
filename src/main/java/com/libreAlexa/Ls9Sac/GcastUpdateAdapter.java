...
public class GcastUpdateAdapter extends BaseAdapter{
    String TAG = GcastUpdateAdapter.class.getSimpleName();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LibreLogger.d(TAG, "Whole Key" + LibreApplication.FW_UPDATE_AVAILABLE_LIST.keySet().toString());
        LibreLogger.d(TAG, "IP " + ipAddress);
